...
from data_provider.biot5plus_classification_translation_dataset import ClassificationTranslationDataset
...
class BioT5PlusClassificationTranslationDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'train',
        num_workers: int = 0,
