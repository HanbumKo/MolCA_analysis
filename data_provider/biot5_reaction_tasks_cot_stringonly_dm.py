...
from data_provider.biot5_reaction_tasks_cot_dataset import BioT5ReactionCoT
import re
...
class BioT5ReactionCoTStringOnlyDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = BioT5ReactionCoT("train")
        self.test_dataset = BioT5ReactionCoT("test")
