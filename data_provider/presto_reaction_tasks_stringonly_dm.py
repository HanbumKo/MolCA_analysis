...
from data_provider.presto_reaction_tasks_stringonly_dataset import PrestoReaction
import re
...
class PrestoStringOnlyDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = PrestoReaction("train", shuffle=True)
        self.val_dataset = PrestoReaction("valid", shuffle=False, n_test_samples=args.n_test_samples)
        self.test_dataset = PrestoReaction("test", shuffle=False, n_test_samples=args.n_test_samples)
