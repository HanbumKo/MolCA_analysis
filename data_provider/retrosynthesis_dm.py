...
from data_provider.retrosynthesis_dataset import Retrosynthesis, USPTORetrosynthesis
import re
...
class RetrosynthesisDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
...
class USPTORetrosynthesisDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = USPTORetrosynthesis(root+'raw_train_processed.csv', text_max_len, self.prompt)
        self.val_dataset = USPTORetrosynthesis(root+'raw_val_processed.csv', text_max_len, self.prompt)
        self.test_dataset = USPTORetrosynthesis(root+'raw_test_processed.csv', text_max_len, self.prompt)
        
        self.train_subset_dataset = USPTORetrosynthesis(root+'raw_train_processed.csv', text_max_len, self.prompt)
        self.train_subset_dataset.data_list = self.train_subset_dataset.data_list[:1000]
