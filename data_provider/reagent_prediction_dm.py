...
from data_provider.reagent_prediction_dataset import ReagentPrediction
import re
...
class ReagentPredictionDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = ReagentPrediction(root+'train.pt', text_max_len, self.prompt)
        self.val_dataset = ReagentPrediction(root+'val.pt', text_max_len, self.prompt)
        self.test_dataset = ReagentPrediction(root+'test.pt', text_max_len, self.prompt)
        
        self.train_subset_dataset = ReagentPrediction(root+'train.pt', text_max_len, self.prompt)
