...
from data_provider.biot5plus_regression_reaction_dataset import RegressionReactionDataset
...
class BioT5PlusRegressionReactionDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'train',
        num_workers: int = 0,
        ...
        self.train_dataset = RegressionReactionDataset('train', shuffle_inst=True)
        # self.train_dataset = RegressionReactionDataset('test')
        self.val_dataset = RegressionReactionDataset('test', shuffle_inst=False)
        self.test_dataset = RegressionReactionDataset('test', shuffle_inst=False)
