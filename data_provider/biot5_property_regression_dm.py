...
from data_provider.biot5_property_regression_dataset import BioT5PropertyRegression
import re
...
class BioT5PropertyRegressionDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = BioT5PropertyRegression("train")
        self.test_dataset = BioT5PropertyRegression("test")
