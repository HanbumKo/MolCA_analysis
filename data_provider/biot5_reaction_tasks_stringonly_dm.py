...
from data_provider.biot5_reaction_tasks_dataset import BioT5Reaction
import re
...
class BioT5ReactionStringOnlyDM(LightningDataModule):
    def __init__(
        self,
        mode: str = 'pretrain',
        num_workers: int = 0,
        ...
        self.train_dataset = BioT5Reaction("train")
        self.test_dataset = BioT5Reaction("test")
