...
from data_provider.pubchem_plusplus_dataset import PubChemPlusPlus
...
class Stage1PlusPlusDM(LightningDataModule):
    def __init__(
        self,
        num_workers: int = 0,
        batch_size: int = 256,
        ...
        if False:
            ...
            self.train_dataset = PubChemPlusPlus(root, text_max_len)
            self.val_dataset = MoleculeCaptionV2("data/PubChem324kV2/" + 'valid.pt', text_max_len)
            self.val_dataset_match = MoleculeCaptionV2("data/PubChem324kV2/" + 'valid.pt', text_max_len).shuffle()
            self.test_dataset = MoleculeCaptionV2("data/PubChem324kV2/" + 'test.pt', text_max_len)
            self.test_dataset_match = MoleculeCaptionV2("data/PubChem324kV2/" + 'test.pt', text_max_len).shuffle()
