...
def visualize_cross_attention_matplot(attention_maps, graphs, idx, root_dir):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filename', type=str, default="finetune_test")
    ...
    args.checkpoint = "all_checkpoints/ft_pubchem324k_from_Extended/last.ckpt"
